var QRCode = (function (t) {
  ...
  var v = l,
    ...
    w = (p.getRowColCoords, p.getPositions, o),
    m = function (t) {
      var r = w(t);
      return [
        [0, 0],
      ...
      (r.mul = function (t, r) {
        ...
        (r.generateECPolynomial = function (t) {
          for (var e = new Uint8Array([1]), n = 0; n < t; n++)
            e = r.mul(e, new Uint8Array([1, M(n)]));
          return e;
        });
    });
  ...
  var L = T,
    ...
    Q = (O.getCapacity, O.getBestVersionForData, O.getEncodedBits, i(1335)),
    V = function (t, r) {
  ...
  function at(t, r, e) {
    ...
    return (function (t, r, e) {
      ...
      var A,
        ...
        M = 0;
      for (A = 0; A < w; A++)
        for (B = 0; B < u; B++) A < v[B].length && (C[M++] = v[B][A]);
